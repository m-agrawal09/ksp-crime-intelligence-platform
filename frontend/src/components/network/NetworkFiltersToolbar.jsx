...
export default function NetworkFiltersToolbar({
  ...
  return (
    <div className="bg-slate-900/85 border border-slate-700/60 rounded-xl p-4 backdrop-blur-md shadow-xl flex flex-col gap-3.5">
      ...
      <div className="flex flex-wrap items-center justify-between gap-2.5">
        ...
        <div className="relative flex-1 min-w-[240px]">
          ...
          <input
            ...
            className="w-full pl-9 pr-7 py-2 bg-slate-950/80 border border-slate-700/70 rounded-lg text-xs text-white placeholder-slate-400 focus:outline-none focus:border-blue-400 focus:ring-1 focus:ring-blue-400/40 transition-all font-mono"
          />
          {searchTerm && (
            <button
        ...
        <div className="flex items-center gap-2">
          <select
            ...
            className="px-3 py-2 bg-slate-950/80 border border-slate-700/70 rounded-lg text-xs text-slate-200 focus:outline-none focus:border-blue-400 font-medium cursor-pointer hover:border-slate-600 transition-colors"
          >
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={onResetView}
            className="px-3 py-2 bg-slate-800/90 hover:bg-slate-700 text-slate-200 hover:text-white border border-slate-700/80 rounded-lg text-xs flex items-center gap-1.5 transition-colors cursor-pointer font-medium"
      ...
      <div className="flex flex-wrap items-center gap-2 pt-2.5 border-t border-slate-700/50">
        ...
        {Object.entries(NODE_COLORS).map(([typeKey, config]) => {
          ...
          return (
            <button
              ...
              className={`px-2.5 py-1 rounded-md text-[11px] font-medium flex items-center gap-1.5 border transition-all cursor-pointer ${
                isActive
